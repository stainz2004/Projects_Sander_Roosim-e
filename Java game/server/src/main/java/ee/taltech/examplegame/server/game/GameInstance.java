...
public class GameInstance extends Thread {
    ...
    public void run() {
        ...
        while (isGameRunning) {
            ...
            bullets = collisionHandler.handleCollisions(bullets, players, monster);

            // construct gameStateMessage
            var gameStateMessage = gameStateHandler.getGameStateMessage(players, bullets, monster);
            ...
            // Apply gravitation
            players.forEach(Player::applyGravitation);
